...
- **工具栏弹窗**：收纳、恢复最近会话；立刻整理当前窗口、按当前页归组、合并全部窗口、解散全部窗口标签组、合并打开的重复网页
...
- **右键菜单**（页面或扩展图标）：收纳当前/全部窗口（默认保留当前页）、立刻整理当前窗口、按当前页归组、整理全部窗口并合并到当前（打开管理页确认）

收纳默认**留下当前页**。需要连当前页一起收进会话时，用弹窗或管理页里的「连当前页一起收纳」。右键收纳成功后，工具栏图标会短暂显示数量。

## 自测清单

- [ ] 弹窗：收纳 / 立刻整理当前窗口 / 按当前页归组 / 合并全部窗口 / 解散全部窗口标签组 / 合并打开的重复网页 / 恢复最近会话（不跳进管理页）
